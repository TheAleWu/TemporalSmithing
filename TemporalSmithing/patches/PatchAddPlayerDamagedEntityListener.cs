...
public class PatchAddPlayerDamagedEntityListener : BulkPatch {

	public PatchAddPlayerDamagedEntityListener(ICoreAPI api) : base(FileLocations(api), TemplatePatch()) { }
	...
	private static JsonPatch TemplatePatch() {
		return new JsonPatch {
			...
			Value = JsonObject.FromJson("{\"code\": \"playerdamagedentitylistener\"}")
		};
	}
